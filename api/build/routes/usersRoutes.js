...
class UsersRoutes {
    ...
    config() {
        ...
        */
        ...
        this.router.get('/getNurseInfo/:id', usersController_1.usersController.getNurseInfo.bind(usersController_1.usersController));
        this.router.get('/getDoctors', usersController_1.usersController.getDoctors.bind(usersController_1.usersController));
        this.router.get('/getDoctorInfo/:id', usersController_1.usersController.getDoctorInfo.bind(usersController_1.usersController));
